require 'set'
require 'opentelemetry/adapters/active_support/notifications/subscription'
      ...
      module Notifications
        ...
        module Subscriber
          ...
          module ClassMethods
            ...
            def subscribe(pattern, span_name, options = {}, tracer = -> { ActiveSupport::Adapter.instance.tracer }, &block)
            ...
            def subscription(span_name, options = {}, tracer = -> { DataActiveSupport::Adapter.instance.tracer }, &block)
